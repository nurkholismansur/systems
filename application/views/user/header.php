            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="<?php echo site_url() ?>user">Stochastic Programming</a>
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav nav-icons">
                            ...
                            <li><a href="<?php echo site_url() ?>user/charts"><i class="icon-bar-chart"></i></a></li>
                        </ul>
                ...
                <div class="row">
                    <div class="span12">
                        <div class="btn-box-row row-fluid">
                            <a href="#" class="btn-box big span12"><i class=" icon-random"></i><b>65%</b>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="<?php echo site_url() ?>user">
                                ...
                                <li>
                                    ...
                                    <ul id="togglePages" class="collapse unstyled">
                                        <li><a href="<?php echo site_url() ?>user/cabaimerah"><i class="icon-leaf"></i> Data Cabai Merah</a></li>
                                        <li><a href="<?php echo site_url() ?>user/distributor"><i class="icon-truck"></i> Data Distributor</a></li>
                                    </ul>
                                </li>
                                <li><a href="<?php echo site_url() ?>user/task"><i class="menu-icon icon-tasks"></i>Data Transaksi</a></li>
                                <li><a href="<?php echo site_url() ?>user/perusahaan"><i class="menu-icon icon-suitcase"></i>Perusahaan</a></li>
                            </ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled">
                                <li><a href="<?php echo site_url() ?>user/charts"><i class="menu-icon icon-bar-chart"></i>Statistik Distribusi</a></li>
                                <li><a href="<?php echo site_url() ?>user/forms"><i class="menu-icon icon-paste"></i>Uncertainty Demand</a></li>
                                <li><a href="<?php echo site_url() ?>user/tables"><i class="menu-icon icon-table"></i>Penjadwalan</a></li>
                            </ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled">
                                <li><a href="<?php echo site_url() ?>user/users"><i class="menu-icon icon-user-md"></i>All Users </a></li>
